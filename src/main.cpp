...
class Cppunit_tests: public Cppunit {
    ...
    void us27_test(){
        //todo
        Repository repo;
        std::vector<std::string> result = {"@I1@","53","@I2@","50","@I3@","24","@I4@","NA","@I5@", "75", "@I6@","53","@I7@","51","@I8@","46","@I9@","50","@I10@","53","@I11@","28","@I12@","49","@I13@","24","@I14@","NA","@I15@","178","@I16@","118","@I17@","85","@I18@","75","@I19@","80","@I20@","59","@I21@","59","@I22@","56","@I23@","30","@I24@","30","@I25@","28"};
        ...
        // std::cout<<"-----US27_result------"<<std::endl;
        // for (auto str: result){
        //     std::cout<<str<<std::endl;
        // }
        // std::cout<<"-----US27_result_END------"<<std::endl;
        CHECKT(result1 == result)
    }
